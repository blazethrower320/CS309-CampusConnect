...
public class ChatServer {
    ...
    private static Map<String, ArrayList<String>> chatMessagesMap = new Hashtable < > ();
    ...
    public void onOpen(Session session, @PathParam("username") String username) throws IOException {
        ...
        if (usernameSessionMap.containsKey(username)) {
            ...
            broadcast("All Users: " + joinedUsers);
        }
    }
    ...
    public void onMessage(Session session, String message) throws IOException {
        ...
        logger.info("[onMessage] [" + time + "] | " + username + ": " + message);

        chatMessagesMap.computeIfAbsent(username, k -> new ArrayList<>()).add(message);
        ...
        else if(message.startsWith("/myChats"))
        {
            broadcast("---------------------");
            for(String msg : chatMessagesMap.get(username))
            {
                broadcast(msg);
            }
            broadcast("Your Chat Log:");
            broadcast("---------------------");

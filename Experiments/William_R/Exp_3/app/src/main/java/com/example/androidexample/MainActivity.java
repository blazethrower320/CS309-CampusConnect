...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageText2 = findViewById(R.id.main_msg_txt2);
        Dogpic = findViewById(R.id.dogpic);

        /* extract data passed into this activity from another activity */
        Bundle extras = getIntent().getExtras();
        if(extras == null) {
            messageText.setText("Welcome To The");
            messageText2.setText("Home Page!");             // set message text invisible initially
            usernameText.setVisibility(View.INVISIBLE);             // set username text invisible initially
            logoutButton.setVisibility(View.INVISIBLE);             // set logout button invisible initially
            Dogpic.setVisibility(View.INVISIBLE);                   // set dogpic invisible initially
        } else {
